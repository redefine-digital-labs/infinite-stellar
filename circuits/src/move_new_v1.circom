...
/// Proves one Round-5 move to an uninitialized coordinate. Unlike the normal
/// move circuit, this statement exposes the destination space Perlin so Move
/// can initialize canonical Planet stats without trusting the caller.
template MoveNewV1() {
    signal input source_location_hash;
    signal input destination_location_hash;
    signal input destination_space_perlin;
    ...
    destination_space_perlin === destinationPerlin.perlin;
    ...
    component intent = ActionIntentV1(5);
