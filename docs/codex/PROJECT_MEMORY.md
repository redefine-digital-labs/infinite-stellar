...
- The typed game SDK and English React client implement the activation journey with deterministic local demo fixtures, checkpoint-shaped finality UX, controller-scoped persistence, and existing-Seat-first resume. Demo screens cannot produce a Sui or Soulidity write; canonical enrollment construction exists, while proof-backed claim/move builders and the chain-backed ranked UI remain fail closed.
