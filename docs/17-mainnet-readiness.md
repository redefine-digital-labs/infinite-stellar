...
| Chain-backed web client | Canonical Soul and deterministic Seat routing are chain-backed; the rendered strategy game remains a local deterministic sandbox | Add checkpoint-derived Manifest/Runtime/Planet/Voyage projections while preserving private local coordinates and proof generation |
